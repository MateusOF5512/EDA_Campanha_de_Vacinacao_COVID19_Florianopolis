...
# VARIAVEIS PARA OS ARQUIVOS CSV -------------------------------------------------------------------
...
# - TOPO E RODAPÉ ------------------------------------------------------------------------
html_title="""
<h1 style="font-size:230%; color:#4169e1; font-family:sans-serif;
...
<hr style= "display: block;
  ...
  border-style: inset;
  border-width: 1.5px;">
  <p style="color:Gainsboro; text-align: center;">Última atualização: 24/11/2022</p>
"""
...
<div class="card">
  <div class="card-body">
    <h2 class="card-title" style="color:#4169E1; font-family:sans-serif; 
                                  text-align: center; padding: 10px 0; font-size:200%;"
                                  >Análise da Campanha de Vacinação</h2>
  </div>
</div>
"""
html_subheader_11="""
<div class="card">
  <div class="card-body" style="border-radius: 50px 50px 50px 50px; background: #4169E1; 
    ...
    <h3 class="card-title" style="background-color:#4169E1; color:#F5F5F5; 
                                  ...
                                  padding-top: 15px; padding-right: 15px; padding-bottom: 0px; padding-left: 15px;
                                  font-size:150%;" 
                                  >Número de Doses & Vacinas Aplicadas</h3>
  </div>
</div>
"""
...
<div class="card">
  <div class="card-body" style="border-radius: 50px 50px 50px 50px; background: #4169E1; 
    ...
    <h3 class="card-title" style="background-color:#4169E1; color:#F5F5F5; 
                                  ...
                                  padding-top: 15px; padding-right: 15px; padding-bottom: 0px; padding-left: 15px;
                                  font-size:150%;" 
                                  >Variação das Doses & Vacinas Aplicadas</h3>
  </div>
</div>
"""
...
<div class="card">
  <div class="card-body" style="border-radius: 50px 50px 50px 50px; background: #4169E1; 
    ...
    <h3 class="card-title" style="background-color:#4169E1; color:#F5F5F5; 
                                  ...
                                  padding-top: 15px; padding-right: 15px; padding-bottom: 0px; padding-left: 15px;
                                  font-size:150%;" 
                                  >Grupo atendimento da Vacinação</h3>
  </div>
</div>
"""
...
<div class="card">
  <div class="card-body">
    ...
    >Análise das Características dos Pacientes Vacinados</h2>
  </div>
</div>
"""
...
<div class="card">
  <div class="card-body" style="border-radius: 15px 15px 0px 0px; background: #4169E1;  
                                ...
                                width: 100%; height: 40px;">
    <h5 class="card-title" style="background-color:#4169E1; color:#F5F5F5; font-family:sans-serif;
                                  padding-top: 10px; padding-right: 0px; padding-bottom: 1px; padding-left: 0px; 
                                  text-align: center;font-size: 100%;" 
