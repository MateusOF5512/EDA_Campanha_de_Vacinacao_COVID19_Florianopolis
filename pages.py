...
### CAMPANHA 1 - LINHA A -> COM FILTRO --------------------------------------------------------
    if status_1 == 'Gráfico Velocimetro - Total e Meta':
        ...
        with col2:
            ...
            st.plotly_chart(figAA1, use_container_width=True, config=config)
        with col3:
            st.write("")
        with col4:
            st.markdown(html_card_header_1_A_010, unsafe_allow_html=True) # Vacinados com 2° Dose
            st.plotly_chart(figAB1, use_container_width=True, config=config)
        with col5:
            st.write("")
        with col6:
            st.markdown(html_card_header_1_A_001, unsafe_allow_html=True) # Vacinados com Dose Adicional
            st.plotly_chart(figAC1, use_container_width=True, config=config)
        with col7:
            st.write("")
        ...
        with col2:
            st.markdown(html_card_header_1_A_100, unsafe_allow_html=True) # Vacinados com 1° Dose
            st.plotly_chart(figAA2, use_container_width=True, config=config)
        with col3:
            st.write("")
        with col4:
            st.markdown(html_card_header_1_A_010, unsafe_allow_html=True) # Vacinados com 2° Dose
            st.plotly_chart(figAB2, use_container_width=True, config=config)
        with col5:
            st.write("")
        with col6:

            st.markdown(html_card_header_1_A_001, unsafe_allow_html=True) # Vacinados com Dose Adicional
            st.plotly_chart(figAC2, use_container_width=True, config=config)
        with col7:
            st.write("")
...
### CAMPANHA 1 - LINHA B -------------------------------------------------------
    with st.container():
        ...
        with col2B:
            ...
            st.plotly_chart(figAD0, use_container_width=True, config=config)
        with col3B:
            st.write("")
        with col4B:
            st.markdown(html_card_header_1_B_24, unsafe_allow_html=True)  # Grupo Atendimento Vacinado por Dose
            st.plotly_chart(figAE2, use_container_width=True, config=config)
        with col5B:
            st.write("")
    ...
    with st.container():
        ...
        with col2C:
            ...
            st.plotly_chart(figAE1, use_container_width=True, config=config)
        with col3C:
            st.write("")
        with col4C:
    ...
    with st.container():
        if status1 == 'Dia':
            ...
            with col2B:
                ...
                st.plotly_chart(figBA0, use_container_width=True, config=config)
            with col3B:
                st.write("")
            with col4B:
                st.markdown(html_card_header_1C12, unsafe_allow_html=True)
                st.plotly_chart(figBB0, use_container_width=True, config=config)
            with col5B:
                st.write("")
        else:
            st.write("Ainda nada")
    ...
    with st.container():
        if status1 == 'Dia':
            ...
            with col2C:
                ...
                df_BC_0_drop = df_BC_0.drop(df_BC_0.columns[[0]], axis=1)
                tabela_aggrid(df=df_BC_0_drop, enabled=True, height=300)
            with col3C:
                st.write("")
        else:
            st.write("Ainda nada")
...
def pacientes1():
    ...
    with st.container():
        ...
        with col2A:
            ...
            st.plotly_chart(fig_CA1_1, use_container_width=True, config=config)
        with col3A:
            st.write("")
        with col4A:
            st.markdown(html_card_header_2A_1_12, unsafe_allow_html=True) # Proporção entre os Sexos
            st.plotly_chart(fig_CA_20, use_container_width=True, config=config)
        with col5A:
            st.write("")
        with col6A:
            st.markdown(html_card_header_2A_1_13, unsafe_allow_html=True) # Vacinados do Sexo Feminino
            st.plotly_chart(fig_CA_30, use_container_width=True, config=config)
        with col7A:
            st.write("")
    ...
    with st.container():
        ...
        with col2B:
            ...
            tabela_aggrid(df=df_CB_02, enabled=False, height=110)
        with col3B:
            st.write("")
    ...
    with st.container():
        ...
        with col2B:
            ...
            st.plotly_chart(fig_CC_10, use_container_width=True, config=config)
        with col3B:
            st.write("")
        with col4B:
            st.markdown(html_card_header_2A_1_32, unsafe_allow_html=True)  # Variação de Vacinados
            st.plotly_chart(fig_CC_20, use_container_width=True, config=config)
        with col5B:
            st.write("")
...
def pacientes2():
    ...
    with st.container():
        ...
        with col2A:
            ...
            st.plotly_chart(fig_DA_1, use_container_width=True, config=config)
        with col3A:
            st.write("")
        with col4A:
            st.markdown(html_card_header_2B_2_12, unsafe_allow_html=True) # Raça/Cor - Dados Agrupados

            df_DA_2_drop = df_DA_2.drop(df_DA_2.columns[[0]], axis=1)
            tabela_aggrid(df=df_DA_2_drop, enabled=False, height=200)
        with col5A:
            st.write("")
    ...
    with st.container():
        ...
        with col2B:
            ...
            st.plotly_chart(fig_DB_1, use_container_width=True, config=config)
        with col3B:
            st.write("")
        with col4B:
            st.markdown(html_card_header_2B_2_22, unsafe_allow_html=True) # Raça/Cor - Dados Agrupados
            st.plotly_chart(fig_DB_2, use_container_width=True, config=config)
        with col5B:
            st.write("")
...
def pacientes3():
    ...
    with st.container():
        ...
        with col2A:
            ...
            st.plotly_chart(fig_EA_1, use_container_width=True, config=config)
        with col3A:
            st.write("")
        with col4A:
            st.markdown(html_card_header_2B_3_22, unsafe_allow_html=True)  # Companha de Vacinação
            st.plotly_chart(fig_EB_2, use_container_width=True, config=config)
        with col5A:
            st.write("")
    ...
    with st.container():
        ...
        with col2B:
            ...
            st.plotly_chart(fig_EB_1, use_container_width=True, config=config)
        with col3B:
            st.write("")
        with col4B:
            st.markdown(html_card_header_2B_3_12, unsafe_allow_html=True)  # Dados Agrupados

            df_EA_2_drop = df_EA_2.drop(df_EA_2.columns[[0]], axis=1)
            tabela_aggrid(df=df_EA_2_drop, enabled=False, height=200)
        with col5B:
            st.write("")
